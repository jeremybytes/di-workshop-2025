# Lab 03 - Dependency Injection Containers and Configuring Primitive Types
...
7. Go back to the `InitializeHouseController` method in the `HouseControlAgent` project.  
